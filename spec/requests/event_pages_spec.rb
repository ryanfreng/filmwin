...
describe 'Event pages' do
  ...
  describe "show" do
    ...
    it { pp "Judging Date: " + pretty_date(event.judging_date) }
    it { should have_content(pretty_date_time(event.show_date)) }
    it { pp "Show Date: " + pretty_date_time(event.show_date) } 
